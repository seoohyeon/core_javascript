...
const createUserCard = ({
  ...
  //const {id, name, email:mail="", website = '사이트'} = user;
  //email:mail하면 email을 이제 mail로 쓸수있다. 프로퍼티 이름을 말이다.
          ...
          <g>
            ...
            >
              <animate
                ...
                values="15 300;49.62722392756278 300;15 300"
                keyTimes="0;0.5;1"
                dur="0.8928571428571428s"
                repeatCount="indefinite"
                calcMode="linear"
                keySplines="0 0.4 0.6 1;0.4 0 1 0.6"
                begin="-0.03696428571428571s"
              ></animate>
            </circle>
            <circle
              cx="50"
            ...
            >
              <animate
                attributeName="stroke-dasharray"
                values="15 300;40.76944060891329 300;15 300"
                keyTimes="0;0.5;1"
                dur="0.8928571428571428s"
                repeatCount="indefinite"
                calcMode="linear"
            ...
            >
              <animate
                attributeName="stroke-dasharray"
                values="15 300;59.43050097123666 300;15 300"
                keyTimes="0;0.5;1"
                dur="0.8928571428571428s"
                repeatCount="indefinite"
                calcMode="linear"
...
export function renderUserCard(node, data) {
  insertLast(node, createUserCard(data));
}
